...
if (Errorlevel = 0) {
sleep 1000
MouseMove, %endposx%, %endposy%
Sleep 2000
Loop, 5
{
MouseClick,L,% endposx, % endposy - 100
Sleep 1500
}
goto, replay
...
ImageSearch, endposx, endposy, %endx%, %endy%, % endx + 360, % endy + 280, *%variance% %A_ScriptDir%\Images\gem2.png
sleep 200
...
ImageSearch, endposx, endposy, %endx%, %endy%, % endx + 360, % endy + 280, *%variance% %A_ScriptDir%\Images\gem.png
sleep 200
