...
Loop {
	...
	Sleep 10
ImageSearch, lobbyplayposx, lobbyplayposy, %lobbyplayx% , %lobbyplayy%, % lobbyplayx + 120, % lobbyplayy + 110, *%variance% %A_ScriptDir%\Images\play.png
if (Errorlevel = 0) {
Sleep 500
...
if (Errorlevel = 1) {
	Sleep 10
	ImageSearch, levelposx, levelposy, %selectx% , %selecty%, % selectx2, % selecty2, *%variance% %A_ScriptDir%\Images\select.png
if (Errorlevel = 0){
Sleep 500
MouseMove, % levelposx, % levelposy
Sleep 500
MouseMove, % levelposx + 50, % levelposy + 200
Sleep 500
MouseClick, L, % levelposx, % levelposy
Sleep 200
goto, act
